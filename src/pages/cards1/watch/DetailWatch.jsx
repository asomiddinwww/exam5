...
import very from "./svg/verify.svg";
import tru from "./svg/truck.svg";
import dd from "./svg/dd.png";
...
const DetailWatch = () => {
  ...
  useEffect(() => {
    setLoader(true);
    axios
      .get(`https://69245b583ad095fb8473e105.mockapi.io/user/watch/${id}`)
  ...
  return (
    <div className="p-10 pt-40 flex justify-around">
      ...
      <div className="p-10 rounded-[10px] shadow-xl flex flex-col gap-4">
        ...
        <div><p>choose your installments period</p></div>
        ...
        <div><button className="p-4 w-full border-2 text-2xl text-[#0C68F4] rounded-2xl hover:bg-[#0C68F4] hover:text-white cursor-pointer">Add to cart</button></div>
      </div>
    </div>
  );
};
