...
const AccessoriesDetail = () => {
  ...
  useEffect(() => {
    setLoader(true);
    axios
      .get(`https://6924e80382b59600d721c1a5.mockapi.io/api/Accessories/${id}`)
  ...
  return (
    <>
      <div className="p-10 pt-40 flex justify-around max-[1166px]:flex-col max-[1166px]:items-center max-[1166px]:gap-10 max-[1166px]:justify-center">
