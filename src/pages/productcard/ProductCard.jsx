      ...
      <div className="w-full pt-20">
        <div className="max-w-[1400px] m-auto px-5">
          <div className="w-full flex items-center justify-between pb-10">
            <h1 className="text-4xl font-[600]">New Products</h1>
            <a href="/">View all</a>
          </div>
          <div className="flex flex-wrap justify-between items-center gap-5 pb-10">
            {data.map((item) => (
              <div className="flex items-center justify-center">
                <Link to={`/ProductCard2/${item.id}`} className="bg-white flex flex-col items-center rounded-2xl shadow-2xl p-4 max-w-xs w-full hover:scale-103 transition-all cursor-pointer hover:text-[#063A88]">
                    <div className="flex ">
